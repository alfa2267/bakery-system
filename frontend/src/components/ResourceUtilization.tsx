...
import { Clock, Activity, TrendingUp, AlertTriangle, CheckCircle, Factory } from 'lucide-react';
                  ...
                  {bottlenecks.map((resource) => (
                    <div key={resource.resource} className="p-3 bg-red-50 border border-red-200 rounded-lg">
                      ...
                      <p className="text-sm text-red-700 mt-1">
                        Consider adding capacity or optimizing scheduling
                      </p>
                    </div>
                  ))}
                </div>
                  ...
                  {underutilized.map((resource) => (
                    <div key={resource.resource} className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                      ...
                      <p className="text-sm text-yellow-700 mt-1">
                        Consider consolidating tasks or reducing capacity
                      </p>
                    </div>
                  ))}
                </div>
